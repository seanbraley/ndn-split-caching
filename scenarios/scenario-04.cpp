...
main(int argc, char* argv[])
{
  ...
  ndn::AppDelayTracer::Install(sta_consumers, "app-delays-trace-stationary-04.txt");
  ndn::AppDelayTracer::Install(sta_mobile_consumers, "app-delays-trace-mobile-04.txt");
  ndn::CsTracer::Install(ap, "cs-trace-ap-04.txt", Seconds(1));
  ndn::CsTracer::Install(routers, "cs-trace-routers-04.txt", Seconds(1));
